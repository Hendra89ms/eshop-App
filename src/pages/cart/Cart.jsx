...
function Cart() {
    ...
    useEffect(() => {
        // REDUCE DATA UNTUK MENDAPAT KAN TOTAL HARGA
        const totalCartData = cartData.reduce((acc, item) => acc + item.total, 0)
        setTotalData(totalCartData)
    }, [totalData])
                            ...
                            <div className="w-[1000px] ">
                                ...
                                <div className="overflow-x-auto mt-8">
                                    <table className="w-full border-[1px] border-slate-400">
                                        ...
                                        <tbody>
                                            {
                                                cartData.length === 0 ? <tr><td>Add Your Cart</td></tr> :
                                    ...
                                    <div className="">
                                        ...
                                        <div className="mt-2 w-[400px] flex flex-col gap-3">
                                            ...
                                            <div className="flex justify-between text-2xl">
                                                <h1>Subtotal</h1>
                                                <div className="text-orange-500">Rp {formatToRupiah(totalData)}</div>
                                            </div>
